...
use App\Mail\UpcomingDomainRenewal as RenewalEmail;
...
class UpcomingDomainRenewal extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return (new RenewalEmail($this->remoteDomain, $this->hostedDomain, $this->daysOut))
    ...
    {
        $message = ":spiral_calendar_pad: Renewal Notice: The domain {$this->remoteDomain->domain} belonging to {$this->hostedDomain->client->name} is set to auto-renew in {$this->daysOut} days.";
