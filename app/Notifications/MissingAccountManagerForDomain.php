...
class MissingAccountManagerForDomain extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {        
        ...
        $message .= " regarding the domain {$this->remoteDomain->domain}, but could not locate the related Account Manager.";
