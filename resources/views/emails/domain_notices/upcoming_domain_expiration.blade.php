...
<main>
    ...
    <div style="background-color: #f3f2ef; border-radius: 4px; padding: 24px 48px;">
        ...
        <!-- Body copy -->
        <p>
            The domain belonging to {{ $hostedDomain->client->name }} is currently set to expire on <span style="white-space: nowrap;">{{ $remoteDomain->expires->toFormattedDateString() }}</span>. 
        </p>
